...
"""This data was collected by the Boston Dynamics AI Institute."""
...
"""
JOINT_PARAMETER_LOOKUP_TABLE: torch.Tensor = torch.tensor(
    [
...
POS_TORQUE_SPEED_LIMIT: torch.Tensor = torch.tensor(
    [
        [-30.0, 96.9972],
        [0.0, 96.9972],
        [14.0, 0.0000],
...
NEG_TORQUE_SPEED_LIMIT: torch.Tensor = torch.tensor(
    [
        [-15.0, 0.0000],
        [0.0, -96.9972],
        [30.0000, -96.9972],
